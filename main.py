...
if __name__ == "__main__":
  ...
  # format outputs into markdown table format to post it online
  with open('output.md', 'w') as f:
    f.write(f"These results are generated in {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}, KST.\n")
    f.write(f"<h4><b>WARNING</b> - Results are generated by GPT, may contain hallucinations.</h4>\n<br>\n")
    ...
    f.write("\n<br>\n## Want to Contribute?\n")
    f.write("Please submit a PR to [this repo](https://github.com/wade3han/gre4phd).\n")
